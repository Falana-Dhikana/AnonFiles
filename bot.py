...
ABOUT_TEXT = """
- **Bot :** `AnonFilesBot`
- **Creator :** [AvishkarPatil](https://telegram.me/Genetry)
        ...
        try:
            ...
            if user.status == "kicked":
                await client.send_message(
                    ...
                    text="**Sᴏʀʀʏ, Yᴏᴜ ᴀʀᴇ Bᴀɴɴᴇᴅ ᴛᴏ ᴜsᴇ ᴍᴇ! Cᴏɴᴛᴀᴄᴛ** [Dᴇᴠᴇʟᴏᴘᴇʀ](https://telegram.me/Genetry).",
                    parse_mode="markdown",
                    disable_web_page_preview=True
                )
                return
            ...
            await client.send_message(
                chat_id=message.chat.id,
                text="**Sᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ Wʀᴏɴɢ! Cᴏɴᴛᴀᴄᴛ ᴍʏ** [Dᴇᴠᴇʟᴏᴘᴇʀ](https://telegram.me/Genetry).",
                parse_mode="markdown",
                disable_web_page_preview=True)
            return
...
bot.start()
print("AnonFilesBot Is Started!,  if Have Any Problems contact @Genetry")
idle()
